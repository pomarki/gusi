const gusi = [
  ...
  },
  {
    ...
    index: 58,
    title: "Другое слово",
    music: "http://music.yandex.ru/album/1309635/track/12072174",
    theme: "лучики радости",
    location: "территория тьмы",
    words: ["утопить", "сжечь", "мор", "глад", "жабы"],
    author: "helgvar",
    link: "https://sur-noname.livejournal.com/105991.html",
    weight: 2006,
    date: new Date("2015, 2, 21"),
    starter: {
      theme: "Он под деревом сидит",
  ...
  },
  {
    ...
    child: "",
    index: 91,
    title: "Only vampires left alive",
    music: "https://www.youtube.com/watch?v=iDK6ir3makA",
    theme: "метаморфозы",
    location: "под дубом",
    words: ["зуб", "клевать", "носки", "заусенец", "блин"],
    author: "taipan_poison",
    link: "https://sur-noname.livejournal.com/105972.html",
    weight: 1849,
  ...
  },
  {
    ...
    music: "https://www.youtube.com/watch?v=DhFy4qZ0ah8",
    theme: "бетховен (собака)",
    location: "зеркальная действительность",
    words: ["месиво", "чупакабра", "похлюпать", "веретенщица", "затерханный"],
    author: "taipan_poison",
    link: "https://sur-noname.livejournal.com/105553.html",
    weight: 1951,
  ...
  },
  {
    ...
    child: "",
    index: 56,
    title: "Карповские иды",
    music: "",
    theme: "услышь мой вой",
    location: "заповедные холмы",
    words: ["перечить", "флагман", "костер", "газета", "вексель"],
    author: "twemon",
    link: "https://sur-noname.livejournal.com/105386.html",
    weight: 2045,
  ...
  },
  {
    ...
    index: 55,
    title: "Допрыгнуть до...",
    music: "https://www.youtube.com/watch?v=jKolJFvqniQ",
    theme: "поиск",
    location: "гараж",
    words: ["веснушки", "кактус", "дырка", "папироса", "мотылёк"],
    author: "somesin",
    link: "https://sur-noname.livejournal.com/105208.html",
    weight: 2007,
